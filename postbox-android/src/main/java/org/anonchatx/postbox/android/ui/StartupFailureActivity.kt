...
import org.anonchatx.postbox.android.ui.StartupFailureActivity.StartupFailure.LIFECYCLE_REUSE
import org.anonchatx.postbox.android.ui.StartupFailureActivity.StartupFailure.SERVICE_ERROR

@AndroidEntryPoint
class StartupFailureActivity : AppCompatActivity() {

    companion object {
        var EXTRA_START_RESULT = "org.anonchatx.postbox.START_RESULT"
    }
